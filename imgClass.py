...
from modules.inputVars import set_variables, get_data_model_path
...
def main():
    ...
    print 'loading data...'
    if load_weights_bool and (os.path.isfile(model_fn)):
