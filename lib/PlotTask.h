...
class PlotTask 
{
  public:
    ...
    void                SetYaxisRange(Double_t ymin, Double_t ymax) {fYMin=ymin; fYMax=ymax; fSetRangeY=kTRUE;}
    ...
    void                SetStdMarkers(Int_t c1=20, Int_t c2=24, Int_t c3=25, 
                                      Int_t c4=25, Int_t c5=27);
    ...
    void                SetLegHeader(TString header) { fLegHeader = header; }

    void                SetDrawOptionAdd(TString drawoption) { fDrawString = drawoption; }
    ...
    void                ToggleAutoRange() { fSetRange = !fSetRange; fSetRangeY = !fSetRangeY; }
    void                ToggleShowPercent() { fPercent = !fPercent; }
    ...
    void                PlotSignificance(TString hnameSig, TString hnameBg, 
                                         TString side="left") const;
    ...
    void                ReductionRateHist(TString horiginal, TString hreduced, 
                                          TString newname, TString newtitle="");
    void                SignalEfficiency(TString horiginal, TString hreduced, 
                                         TString newname, TString newtitle="");

    // create a new histogram as a weighted mixture of two other histograms
    void                CreateHistWithScale(TString hist1, TString hist2, 
  ...
  private:
    ...
    Bool_t              fSetRange;
    Bool_t              fSetRangeY;
    // if percent in PlotAdd should be shown
    Bool_t              fPercent;
    ...
    TCanvas*            Significance(TH1F* h_sig, TH1F* h_bg, TString side="left") const;
