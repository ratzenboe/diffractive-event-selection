...
def main():
    ...
    try:
        ...
        print('::  Saving the id of all events in {}...'.format(model_dir+"all_evts_id.txt"))
        allfile = open(model_dir+"all_evts_id.txt", 'w')
        for item in evt_dictionary['event'][evt_id_string].ravel().tolist():
            allfile.write("%s\n" % item)
