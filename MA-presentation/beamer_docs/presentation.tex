...
\begin{frame}
    ...
    \centering\begin{tikzpicture}
        ...
        \node (nonD) at (-4.2,0) [text width=3cm] {\small Incident hadrons acquire color\\ $\to$~break apart};
        \node (D) at (4.5,0) [text width=3cm] {\small Colorless exchange};
        \node (nonDbelow) at (-2.5,-3.2) [text width=6cm] {\small$\eta$~gap exponentially suppressed};
        \node (Dbelow) at (4.4,-3.2) [text width=6cm] {\small$\eta$~ gap not suppressed};
...
\begin{frame}
    ...
    \centering\begin{tikzpicture}
        ...
        \node<3->[] (vetodets) at (0,-3) {\small Small detectors for global event characterization};
...
\begin{frame}
    ...
    \end{itemize}
    \centering\begin{tikzpicture}
        \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=3cm,keepaspectratio]{pics/CEP1.pdf}};
        % \node[align = center, above = of cep, yshift=-15mm] {\small CEP};
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<2-> Remaining background are partially reconstructed CEP events - \textbf{feed down}
    \end{itemize}
    % \vspace*{1mm}
    \centering\begin{tikzpicture}
...
\begin{frame}
    ...
    \centering\begin{tikzpicture}
        ...
        \node[inner sep=0pt] (cep2) at (0,-3) {\includegraphics[height=3cm,keepaspectratio]{pics/CEP1.pdf}};
...
\begin{frame}
    \frametitle{Feed down}
    \centering\includegraphics[width=9cm,keepaspectratio]{pics/FD_list}%
%     \centering\begin{tikzpicture}
%         \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=3cm,keepaspectratio]{pics/doc}};
%     \end{tikzpicture}
\end{frame}
...
\begin{frame}
    \frametitle{Feed down}
    \centering\includegraphics[width=11.5cm,keepaspectratio]{pics/AnalysisResults_fInvMass_FD_fInvMass_FD_hasGammas_fInvMass_FD_emcal_add_save}%
\end{frame}
...
\begin{frame}
    ...
    \centering\includegraphics[width=11.5cm,keepaspectratio]{pics/AnalysisResults_hitfiles_fGammaE_fSecondaryE_BG_log_SigBg}%
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[T] % align columns
        \begin{column}{.48\textwidth}
            \centering\includegraphics[width=6.0cm,keepaspectratio]{pics/AnalysisResults_hitfiles_fGammaE_fSecondaryE_BG_log_SigBg}%
        \end{column}%
        \hfill%
        \begin{column}{.48\textwidth}
            \centering\includegraphics[width=6.0cm,keepaspectratio]{pics/2012-Aug-07-Trigger_efficiency_EMCal_cluster}%
        \end{column}%
    \end{columns}
\end{frame}
...
%     \vspace*{3mm}
%     \centering\begin{tikzpicture}
%         \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=8cm,keepaspectratio]{pics/2012-Aug-07-Trigger_efficiency_EMCal_cluster}}
%     \end{tikzpicture}
% \end{frame}
...
\begin{frame}
    ...
    \centering\includegraphics[width=11.5cm,keepaspectratio]{pics/t-sne_perplexitiy30_npts3000}%
\end{frame}
...
\begin{frame}
    ...
    \centering\begin{tikzpicture}
        ...
        \node<2>[below=1cm of actpic,inner sep=0pt] (dist) {\includegraphics[height=4.1cm,keepaspectratio]{pics/MVAoutput_distr_train_log.pdf}};
...
\begin{frame}
    \frametitle{Visualizing the hidden layer}
    \begin{columns}[T] % align columns        
        \begin{column}{.48\textwidth}
            \vspace*{-5mm}
            \begin{enumerate}
...
\begin{frame}
    ...
    \vspace*{5mm}
    \centering\begin{tikzpicture}
        \node[inner sep=0pt] (cov) at (0,0) {\includegraphics[height=5.1cm,keepaspectratio]{pics/detected_simulated_newLabels}};
        \node[above=of cov, yshift=-15mm] (txt) {$\to$~increasing~$\Delta\eta$};
...
\begin{frame}
    ...
    \centering\begin{tikzpicture}
        ...
        \node [draw,circle,cross,minimum width=1 cm,draw=orange,fill=orange!20] (concat) at (6,-3.1) {}; 

        \node[right=of rectFMD,xshift=-2mm] (rectNNFMD) [text=black,draw=orange,fill=orange!20,rectangle, minimum height=5mm,minimum width=10mm,draw, thick,rounded corners] {\tiny NN};
        ...
        \node[right=of rectV0,xshift=-2mm] (rectNNV0) [text=black,draw=orange,fill=orange!20,rectangle,minimum height=5mm,minimum width=10mm,draw, thick,rounded corners] {\tiny NN};
        \node[right=of rectNNV0,xshift=2mm] (VetoAux) [draw=orange,fill=orange!20,circle,draw, thick,minimum size=6mm] {\tiny Aux};
        ...
        \node[right=of rectAD,xshift=-2mm] (rectNNad) [text=black,draw=orange,fill=orange!20,rectangle, minimum height=5mm,minimum width=10mm,draw, thick,rounded corners] {\tiny NN};
        ...
        \node[right=of rectEMC,xshift=-2mm] (rectRNNemc) [text=black,draw=orange,fill=orange!20,rectangle, minimum height=5mm,minimum width=10mm,draw, thick,rounded corners] {\tiny RNN};
        \node[right=of rectRNNemc,xshift=2mm,yshift=-3mm] (VetoAuxCalo) [draw=orange,fill=orange!20,circle,draw, thick,minimum size=6mm] {\tiny Aux};
        ...
        \node[right=of rectPHOS,xshift=-2mm] (rectRNNphos) [text=black,draw=orange,fill=orange!20,rectangle, minimum height=5mm,minimum width=10mm,draw, thick,rounded corners] {\tiny RNN};
        ...
        \node[right=of rectTrack,xshift=-2mm] (rectRNNtrack) [text=black,draw=orange,fill=orange!20,rectangle, minimum height=5mm,minimum width=10mm,draw, thick,rounded corners] {\tiny RNN};
        \node[right=of rectRNNtrack,xshift=2mm,yshift=0mm] (VetoAuxTrack) [draw=orange,fill=orange!20,circle,draw, thick,minimum size=6mm] {\tiny Aux};
        ...
        \draw[->] (rectEvent) -- (6,-6.2) -- (concat);
        \draw[->] (VetoAuxTrack) -- (concat);
        \draw[->] (VetoAuxCalo) -- (concat);
        \draw[->] (VetoAux) -- (6,-0.75)  -- (concat);

        \node[right=of concat,xshift=-2mm] (DNN) [text=black,draw=orange,fill=orange!20,rectangle, minimum height=8mm,minimum width=14mm,draw, thick,rounded corners] {\footnotesize DNN};

        \draw[->] (concat) -- (DNN);

        \node[right=of DNN,xshift=-4mm] (y) [text=black] {\footnotesize $y$};

        \draw[->] (DNN) -- (y);

        \draw [decorate,decoration={brace,mirror,amplitude=15pt},xshift=0mm,yshift=0pt]
            (rectFMD.north west) -- (rectEvent.south west) node (brace) [black,midway,xshift=-8mm] 
            {$\boldsymbol{x}$};
...
\begin{frame}
    ...
    \centering\begin{tikzpicture}
        ...
        \draw [decorate,decoration={brace,amplitude=15pt},xshift=5mm,yshift=0pt]
            (f1.north east) -- (fn.south east) node (brace) [black,midway,xshift=15mm] 
...
\begin{frame}
    ...
    \centering\includegraphics[width=9cm,keepaspectratio]{pics/model_loss}%
%     \centering\begin{tikzpicture}
%         \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=3cm,keepaspectratio]{pics/doc}};
%     \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \centering\includegraphics[width=9cm,keepaspectratio]{pics/roc_curve_train_new}%
%     \centering\begin{tikzpicture}
%         \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=3cm,keepaspectratio]{pics/doc}};
%     \end{tikzpicture}
\end{frame}
...
\begin{frame}
    \frametitle{Backup: Learning curve}
    \centering\includegraphics[width=11cm,keepaspectratio]{pics/learningcurve_rocauc_epochs}%
%     \centering\begin{tikzpicture}
%         \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=3cm,keepaspectratio]{pics/doc}};
%     \end{tikzpicture}
\end{frame}
...
\begin{frame}
    \frametitle{Backup: Learning curve}
    \centering\includegraphics[width=11cm,keepaspectratio]{pics/learningcurve_rocauc_epochs_good}%
%     \centering\begin{tikzpicture}
%         \node[inner sep=0pt] (cep) at (0,0) {\includegraphics[height=3cm,keepaspectratio]{pics/doc}};
%     \end{tikzpicture}
\end{frame}
